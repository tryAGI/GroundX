...
namespace GroundX
{
    public partial class DocumentsClient
    {
        ...
        partial void PrepareDocumentCrawlWebsiteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::GroundX.WebsiteCrawlRequest request);
        partial void ProcessDocumentCrawlWebsiteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDocumentCrawlWebsiteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GroundX.IngestResponse> DocumentCrawlWebsiteAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::GroundX.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::GroundX.AutoSDKHttpResponse<global::GroundX.IngestResponse>> DocumentCrawlWebsiteAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDocumentCrawlWebsiteArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDocumentCrawlWebsiteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::GroundX.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentCrawlWebsite",
                                methodName: "DocumentCrawlWebsiteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDocumentCrawlWebsiteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDocumentCrawlWebsiteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::GroundX.IngestResponse> DocumentCrawlWebsiteAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::GroundX.WebsiteCrawlRequest
            {
                Websites = websites,
            };

            return await DocumentCrawlWebsiteAsync(
                request: __request,
                requestOptions: requestOptions,
