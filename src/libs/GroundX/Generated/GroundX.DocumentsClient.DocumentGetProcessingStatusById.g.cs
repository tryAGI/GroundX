...
namespace GroundX
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement s_DocumentGetProcessingStatusByIdSecurityRequirement0 =
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement[] s_DocumentGetProcessingStatusByIdSecurityRequirements =
            new global::GroundX.EndPointSecurityRequirement[]
            {                s_DocumentGetProcessingStatusByIdSecurityRequirement0,
            };
        partial void PrepareDocumentGetProcessingStatusByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid processId);
        partial void PrepareDocumentGetProcessingStatusByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid processId);
        partial void ProcessDocumentGetProcessingStatusByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDocumentGetProcessingStatusByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GroundX.ProcessStatusResponse> DocumentGetProcessingStatusByIdAsync(
            global::System.Guid processId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::GroundX.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::GroundX.AutoSDKHttpResponse<global::GroundX.ProcessStatusResponse>> DocumentGetProcessingStatusByIdAsResponseAsync(
            global::System.Guid processId,
            global::GroundX.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDocumentGetProcessingStatusByIdArguments(
            ...
            var __authorizations = global::GroundX.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DocumentGetProcessingStatusByIdSecurityRequirements,
                operationName: "DocumentGetProcessingStatusByIdAsync");

            using var __timeoutCancellationTokenSource = global::GroundX.AutoSDKRequestOptionsSupport.CreateTimeoutCancellationTokenSource(
                clientOptions: Options,
                requestOptions: requestOptions,
                cancellationToken: cancellationToken);
            var __effectiveCancellationToken = __timeoutCancellationTokenSource?.Token ?? cancellationToken;
            var __effectiveReadResponseAsString = global::GroundX.AutoSDKRequestOptionsSupport.GetReadResponseAsString(
                clientOptions: Options,
                requestOptions: requestOptions,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            clientOptions: Options,
                            context: global::GroundX.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentGetProcessingStatusById",
                                methodName: "DocumentGetProcessingStatusByIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDocumentGetProcessingStatusByIdResponse(
                    httpClient: HttpClient,
                    httpResponseMessage: __response);
                if (__response.IsSuccessStatusCode)
                {
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnAfterSuccessAsync(
                            clientOptions: Options,
                            context: global::GroundX.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentGetProcessingStatusById",
                                methodName: "DocumentGetProcessingStatusByIdAsync",
                ...
                else
                {
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDocumentGetProcessingStatusByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::GroundX.AutoSDKHttpResponse<global::GroundX.ProcessStatusResponse>(
                                        statusCode: __response.StatusCode,
