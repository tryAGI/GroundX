...
namespace GroundX
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement s_DocumentIngestRemoteSecurityRequirement0 =
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement[] s_DocumentIngestRemoteSecurityRequirements =
            new global::GroundX.EndPointSecurityRequirement[]
            {                s_DocumentIngestRemoteSecurityRequirement0,
            };
        partial void PrepareDocumentIngestRemoteArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::GroundX.DocumentRemoteIngestRequest request);
        partial void PrepareDocumentIngestRemoteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::GroundX.DocumentRemoteIngestRequest request);
        partial void ProcessDocumentIngestRemoteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDocumentIngestRemoteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GroundX.IngestResponse> DocumentIngestRemoteAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::GroundX.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::GroundX.AutoSDKHttpResponse<global::GroundX.IngestResponse>> DocumentIngestRemoteAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDocumentIngestRemoteArguments(
            ...
            var __authorizations = global::GroundX.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DocumentIngestRemoteSecurityRequirements,
                operationName: "DocumentIngestRemoteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDocumentIngestRemoteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::GroundX.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentIngestRemote",
                                methodName: "DocumentIngestRemoteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDocumentIngestRemoteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDocumentIngestRemoteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await DocumentIngestRemoteAsync(
                request: __request,
                requestOptions: requestOptions,
