...
namespace GroundX
{
    public partial interface IHealthClient
    {
        ...
        global::System.Threading.Tasks.Task<global::GroundX.HealthResponse> HealthListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::GroundX.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::GroundX.AutoSDKHttpResponse<global::GroundX.HealthResponse>> HealthListAsResponseAsync(
            global::GroundX.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}