...
namespace GroundX
{
    public partial class DocumentsClient
    {
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement s_DocumentIngestLocalSecurityRequirement0 =
        ...
        private static readonly global::GroundX.EndPointSecurityRequirement[] s_DocumentIngestLocalSecurityRequirements =
            new global::GroundX.EndPointSecurityRequirement[]
            {                s_DocumentIngestLocalSecurityRequirement0,
            };
        partial void PrepareDocumentIngestLocalArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Collections.Generic.IList<global::GroundX.DocumentLocalIngestRequestItem> request);
        partial void PrepareDocumentIngestLocalRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Collections.Generic.IList<global::GroundX.DocumentLocalIngestRequestItem> request);
        partial void ProcessDocumentIngestLocalResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDocumentIngestLocalResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::GroundX.IngestResponse> DocumentIngestLocalAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::GroundX.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::GroundX.AutoSDKHttpResponse<global::GroundX.IngestResponse>> DocumentIngestLocalAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDocumentIngestLocalArguments(
            ...
            var __authorizations = global::GroundX.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DocumentIngestLocalSecurityRequirements,
                operationName: "DocumentIngestLocalAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDocumentIngestLocalRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::GroundX.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentIngestLocal",
                                methodName: "DocumentIngestLocalAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDocumentIngestLocalResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::GroundX.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDocumentIngestLocalResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
